  ...
  },
  {
    ...
    comments: [
      ...
      },
      {
        ...
        text: "This thread is a gentle reminder to cherish the journey, embrace growth, and live with purpose.",
        votes: {
          upvotedBy: [],
          downvotedBy: [],
        },
    ...
    comments: [
      {
        ...
        avatarUrl:
          "https://res.cloudinary.com/dptfwcnro/image/upload/v1685595920/SocialBuzz/images_qynsis.jpg",
        text: "Absolutely! Every challenge is an opportunity for growth and learning. 💯",
        votes: {
          upvotedBy: [],
          downvotedBy: [],
        },
      },
      {
        ...
        text: "I love the positive mindset! Challenges make us stronger and more resilient.💪💥 Keep pushing forward!",
        votes: {
          upvotedBy: [],
          downvotedBy: [],
        },
    ...
    comments: [
      {
        ...
        text: "I'm always inspired by your travel stories. Looking forward to it! ✈️🌍",
        votes: {
          upvotedBy: [],
          downvotedBy: [],
        },
    ...
    comments: [
      ...
      },
      {
        ...
        avatarUrl:
          "https://res.cloudinary.com/dptfwcnro/image/upload/v1685595920/SocialBuzz/images_qynsis.jpg",
        website: "https://sophieclark.com/",
        text: "I'm always looking for book recommendations. Thanks for sharing! 🙏",
        votes: {
          upvotedBy: [],
          downvotedBy: [],
        },
    ...
    comments: [
      ...
      },
      {
        ...
        avatarUrl:
          "https://res.cloudinary.com/dptfwcnro/image/upload/v1685595740/SocialBuzz/images_zrbwa3.jpg",
        website: "https://emmadavis.com/",
        text: "Enjoy your adventure! Traveling is the best way to broaden our horizons. 🌍✈️",
        votes: {
          upvotedBy: [],
          downvotedBy: [],
        },
